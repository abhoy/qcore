...
void qasm3Parser::NopStatementContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<qasm3ParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterNopStatement(this);
}

void qasm3Parser::NopStatementContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<qasm3ParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitNopStatement(this);
}
